...
export function UploadFile({ onFileUpload, onClick, gotFile, fileName, onDownload }: UploadFileProps) {
  ...
  return (
    <div className="bg-black w-screen h-screen">
      <div className="w-full h-full pt-44 pb-44 mx-auto min-h-96 border border-dashed bg-black dark:bg-black border-neutral-200 dark:border-neutral-800 rounded-lg">
